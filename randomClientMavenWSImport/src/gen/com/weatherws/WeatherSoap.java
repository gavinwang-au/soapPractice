...
public interface WeatherSoap {
     ...
     * 
     * @return
     *     returns gen.com.weatherws.ArrayOfWeatherDescription
     */
    ...
    @RequestWrapper(localName = "GetWeatherInformation", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "gen.com.weatherws.GetWeatherInformation")
    @ResponseWrapper(localName = "GetWeatherInformationResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "gen.com.weatherws.GetWeatherInformationResponse")
     ...
     * @param zip
     * @return
     *     returns gen.com.weatherws.ForecastReturn
     */
    ...
    @RequestWrapper(localName = "GetCityForecastByZIP", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "gen.com.weatherws.GetCityForecastByZIP")
    @ResponseWrapper(localName = "GetCityForecastByZIPResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "gen.com.weatherws.GetCityForecastByZIPResponse")
     ...
     * @param zip
     * @return
     *     returns gen.com.weatherws.WeatherReturn
     */
    ...
    @RequestWrapper(localName = "GetCityWeatherByZIP", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "gen.com.weatherws.GetCityWeatherByZIP")
    @ResponseWrapper(localName = "GetCityWeatherByZIPResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "gen.com.weatherws.GetCityWeatherByZIPResponse")
