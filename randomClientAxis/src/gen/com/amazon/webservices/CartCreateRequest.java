...
public class CartCreateRequest  implements java.io.Serializable {
    ...
    private gen.com.amazon.webservices.CartCreateRequestItemsItem[] items;
    ...
    public CartCreateRequest(
           ...
           gen.com.amazon.webservices.CartCreateRequestItemsItem[] items,
     ...
     * @return items
     */
    public gen.com.amazon.webservices.CartCreateRequestItemsItem[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(gen.com.amazon.webservices.CartCreateRequestItemsItem[] items) {
        this.items = items;
    }
