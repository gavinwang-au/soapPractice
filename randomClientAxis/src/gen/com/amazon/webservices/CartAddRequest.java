...
public class CartAddRequest  implements java.io.Serializable {
    ...
    private gen.com.amazon.webservices.CartAddRequestItemsItem[] items;
    ...
    public CartAddRequest(
           ...
           gen.com.amazon.webservices.CartAddRequestItemsItem[] items,
     ...
     * @return items
     */
    public gen.com.amazon.webservices.CartAddRequestItemsItem[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(gen.com.amazon.webservices.CartAddRequestItemsItem[] items) {
        this.items = items;
    }
