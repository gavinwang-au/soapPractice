...
public class CartItems  implements java.io.Serializable {
    ...
    private gen.com.amazon.webservices.CartItem[] cartItem;
    ...
    public CartItems(
           ...
           gen.com.amazon.webservices.CartItem[] cartItem) {
     ...
     * @return cartItem
     */
    public gen.com.amazon.webservices.CartItem[] getCartItem() {
        return cartItem;
    }
     ...
     * @param cartItem
     */
    public void setCartItem(gen.com.amazon.webservices.CartItem[] cartItem) {
        this.cartItem = cartItem;
    }

    public gen.com.amazon.webservices.CartItem getCartItem(int i) {
        return this.cartItem[i];
    }

    public void setCartItem(int i, gen.com.amazon.webservices.CartItem _value) {
