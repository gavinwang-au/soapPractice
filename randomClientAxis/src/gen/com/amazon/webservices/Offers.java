...
public class Offers  implements java.io.Serializable {
    ...
    private gen.com.amazon.webservices.Offer[] offer;
    ...
    public Offers(
           ...
           gen.com.amazon.webservices.Offer[] offer) {
     ...
     * @return offer
     */
    public gen.com.amazon.webservices.Offer[] getOffer() {
        return offer;
    }
     ...
     * @param offer
     */
    public void setOffer(gen.com.amazon.webservices.Offer[] offer) {
        this.offer = offer;
    }

    public gen.com.amazon.webservices.Offer getOffer(int i) {
        return this.offer[i];
    }

    public void setOffer(int i, gen.com.amazon.webservices.Offer _value) {
        this.offer[i] = _value;
    }
