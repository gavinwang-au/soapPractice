...
public class CartModifyRequest  implements java.io.Serializable {
    ...
    private gen.com.amazon.webservices.CartModifyRequestItemsItem[] items;
    ...
    public CartModifyRequest(
           ...
           gen.com.amazon.webservices.CartModifyRequestItemsItem[] items,
     ...
     * @return items
     */
    public gen.com.amazon.webservices.CartModifyRequestItemsItem[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(gen.com.amazon.webservices.CartModifyRequestItemsItem[] items) {
        this.items = items;
    }
